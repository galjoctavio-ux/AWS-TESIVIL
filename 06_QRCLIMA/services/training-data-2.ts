...
export const TRAINING_DATA_BLOCKS_5_8: TrainingModuleData[] = [
    // ============== BLOQUE 5: Sistemas Inverter ==============
    {
        ...
        level: 'Avanzado', category: 'HVAC', block: 5, tokens: 18, time: 2,
        questions: [
    ...
    },
    {
        ...
        level: 'Avanzado', category: 'HVAC', block: 5, tokens: 18, time: 1,
        questions: [
    ...
    // ============== BLOQUE 6: Electrónica de Potencia ==============
    {
        ...
        level: 'Avanzado', category: 'Electricidad', block: 6, tokens: 18, time: 2,
        questions: [
    ...
    },
    {
        ...
        level: 'Avanzado', category: 'HVAC', block: 6, tokens: 18, time: 2,
        questions: [
    ...
    },
    {
        ...
        level: 'Avanzado', category: 'Electricidad', block: 6, tokens: 18, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Avanzado', category: 'HVAC', block: 6, tokens: 18, time: 1,
        questions: [
    ...
    // ============== BLOQUE 7: Electricidad Básica ==============
    {
        ...
        level: 'Básico', category: 'Electricidad', block: 7, tokens: 8, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Básico', category: 'Electricidad', block: 7, tokens: 8, time: 2,
        questions: [
    ...
    // ============== BLOQUE 8: Calidad de Energía ==============
    {
        ...
        level: 'Avanzado', category: 'Electricidad', block: 8, tokens: 18, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Avanzado', category: 'Electricidad', block: 8, tokens: 18, time: 2,
        questions: [
