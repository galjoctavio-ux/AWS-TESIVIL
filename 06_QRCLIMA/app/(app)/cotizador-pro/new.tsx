...
export default function NewQuoteScreen() {
    ...
    const handleSelectClient = (client: ClientData & { id: string }) => {
        router.push({
            pathname: '/(app)/cotizador-pro/add-concepts',
            params: {
                clientId: client.id,
        ...
        <View className="flex-1 bg-slate-50">
            ...
            <View className="bg-blue-600 pb-4 px-4" style={{ paddingTop: insets.top + 8 }}>
                <View className="flex-row items-center justify-between mb-4">
                    ...
                    <Text className="text-xl font-bold text-white">Seleccionar Cliente</Text>
                    <View style={{ width: 24 }} />
                </View>
                ...
                <View className="flex-1 bg-black/50 justify-end">
                    <View className="bg-white rounded-t-3xl p-6" style={{ paddingBottom: insets.bottom + 16 }}>
                        ...
                        <TouchableOpacity
                            ...
                            disabled={saving}
                            className={`py-4 rounded-xl ${saving ? 'bg-gray-400' : 'bg-blue-600'}`}
                        >
                            {saving ? (
