...
(function (exports) {
    ...
    function bindEventHandlers() {
        ...
        $calendarPage.on('click', '.edit-popover', function () {
            ...
            if (lastFocusedEventData.data.workingPlanException) {
                ...
                // --- CUSTOM TESIVIL: Cargar datos adicionales ---
                BackendCalendarAppointmentsModal.loadAppointmentData(appointment);
                // ------------------------------------------------
                $dialog.modal('show');
            } else {
    ...
    exports.initialize = function () {
        ...
        if (GlobalVariables.editAppointment) {
            ...
            // --- CUSTOM TESIVIL: Cargar datos adicionales al abrir por hash ---
            BackendCalendarAppointmentsModal.loadAppointmentData(appointment);
            // -----------------------------------------------------------------
