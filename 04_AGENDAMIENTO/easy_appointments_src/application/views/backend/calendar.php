                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="form-group">
    <label for="address-autocomplete-container" class="control-label">
        Dirección (Google Maps)
    </label>
    <div id="address-autocomplete-container"></div>
    
    <!-- Inputs ocultos para enviar al backend -->
    <input type="hidden" id="appointment-location" name="appointment-location">
    <input type="hidden" id="appointment-direction-link" name="appointment-direction-link">
    
    <!-- Mostrar dirección guardada (solo lectura) -->
    <small id="saved-location-display" class="form-text text-muted" style="display:none;">
        <i class="fas fa-map-marker-alt mr-1"></i>
        <strong>Guardado:</strong> <span id="saved-location-text"></span>
    </small>
</div>

<div class="form-group">
    <div class="form-check">
        <input class="form-check-input" type="checkbox" value="60" id="appointment-buffer-traslado">
        <label class="form-check-label" for="appointment-buffer-traslado">
            Añadir 1h de traslado (Buffer)
        </label>
    </div>
</div>

<div class="form-group">
    <label for="appointment-notes-aviso" class="control-label">Aviso (Notas Internas)</label>
    <textarea id="appointment-notes-aviso" class="form-control" rows="2" placeholder="Ej: Casa naranja, preguntar por..."></textarea>
</div>

<div class="form-group">
    <label for="appointment-notes-pago" class="control-label">Pago (Notas Cliente)</label>
    <textarea id="appointment-notes-pago" class="form-control" rows="2" placeholder="Ej: No cobrar, pagado, etc."></textarea>
</div>
