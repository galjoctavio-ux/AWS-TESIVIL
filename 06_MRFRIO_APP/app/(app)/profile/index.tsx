...
export default function ProfileScreen() {
    ...
    const settingsSection = [
        { id: 'settings', icon: 'settings', label: 'Configuración', route: null, iconColor: '#6B7280', iconBg: 'bg-gray-100' },
        { id: 'subscription', icon: 'star', label: 'Suscripción PRO', route: null, iconColor: '#F59E0B', iconBg: 'bg-amber-100' },
        { id: 'help', icon: 'help-circle', label: 'Ayuda', route: null, iconColor: '#3B82F6', iconBg: 'bg-blue-100' },
    ];

    const renderMenuItem = (item: typeof communitySection[0]) => (
        <TouchableOpacity
            key={item.id}
        ...
        >
            ...
            <View className="flex-1">
                ...
                {item.sublabel && <Text className="text-gray-500 text-sm">{item.sublabel}</Text>}
            </View>
    ...
    return (
        ...
        >
            ...
            <View className="bg-blue-600 pt-14 pb-20 px-5">
                <Text className="text-white text-2xl font-bold mb-2">Mi Perfil</Text>
            </View>
                ...
                <View className="bg-white rounded-3xl p-5 shadow-lg border border-gray-100">
                    ...
                    <View className="bg-gray-50 rounded-2xl p-4">
                        ...
                        {completenessScore < 100 && (
                            <TouchableOpacity className="mt-2">
                                <Text className="text-blue-600 text-sm font-medium">Completar perfil →</Text>
                            </TouchableOpacity>
                        )}
                    </View>
                    ...
                    <View className="flex-row mt-4 pt-4 border-t border-gray-100">
                        ...
                        <View className="flex-1 items-center">
                            ...
                            <Text className="text-gray-500 text-xs">QRs Activos</Text>
                        </View>
                        <View className="w-px bg-gray-100" />
                        <View className="flex-1 items-center">
            ...
            <View className="px-4 mb-6">
                ...
                {communitySection.map(renderMenuItem)}
            </View>
