...
export const INITIAL_TRAINING_DATA: TrainingModuleData[] = [
    // ============== BLOQUE 1: Tendencias y Tecnología ==============
    {
        ...
        level: 'Básico', category: 'HVAC', block: 1, tokens: 15, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Básico', category: 'HVAC', block: 1, tokens: 20, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Básico', category: 'Electricidad', block: 1, tokens: 20, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Básico', category: 'Seguridad', block: 1, tokens: 10, time: 1,
        questions: [
    ...
    // ============== BLOQUE 2: Herramientas y Documentación ==============
    {
        ...
        level: 'Básico', category: 'Negocio', block: 2, tokens: 25, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Básico', category: 'Herramientas', block: 2, tokens: 20, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Básico', category: 'Herramientas', block: 2, tokens: 15, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Básico', category: 'HVAC', block: 2, tokens: 20, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Básico', category: 'Negocio', block: 2, tokens: 15, time: 1,
        questions: [
    ...
    // ============== BLOQUE 3: Termodinámica y Diagnóstico ==============
    {
        ...
        level: 'Intermedio', category: 'HVAC', block: 3, tokens: 35, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Intermedio', category: 'HVAC', block: 3, tokens: 30, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Intermedio', category: 'Electricidad', block: 3, tokens: 30, time: 1,
        questions: [
    ...
    },
    {
        ...
        level: 'Intermedio', category: 'HVAC', block: 3, tokens: 45, time: 2,
        questions: [
    ...
    // ============== BLOQUE 4: Componentes Críticos y Fallas ==============
    {
        ...
        level: 'Intermedio', category: 'HVAC', block: 4, tokens: 50, time: 2,
        questions: [
    ...
    },
    {
        ...
        level: 'Intermedio', category: 'HVAC', block: 4, tokens: 40, time: 2,
        questions: [
    ...
    },
    {
        ...
        level: 'Intermedio', category: 'HVAC', block: 4, tokens: 45, time: 2,
        questions: [
    ...
    },
    {
        ...
        level: 'Intermedio', category: 'HVAC', block: 4, tokens: 30, time: 1,
        questions: [
