...
<section className="w-full bg-white py-16 md:py-24 px-6">
  <div className="max-w-3xl mx-auto text-center">
    ...
    {/* NUEVO CONTENEDOR FLEX: 
      - mt-10: Se separa del bloque de urgencia.
      - flex flex-col: Apila los elementos verticalmente.
      - items-center: Centra los elementos.
      - gap-y-6: Crea un espacio de 6 unidades (1.5rem) ENTRE los badges y el botón.
    */}
    <div className="mt-10 flex flex-col items-center gap-y-6">

      {/* Badges de Confianza (SIN MARGEN SUPERIOR, el 'gap' se encarga) */}
      ...
      {/* CTA Principal (SIN MARGEN SUPERIOR, y con ancho definido) */}
      <Link
        href="#"
        onClick={handleCtaClick}
        className={`
          ...
          hover:scale-105 hover:shadow-lg
          ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}
          w-full max-w-md  {/* <-- AÑADE ESTO para que el botón tenga un ancho */}
        `}
        disabled={isProcessing}
      >
